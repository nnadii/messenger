...
const DesktopSidebar: React.FC<DesktopSidebarProps> = ({ currentUser }) => {
    ...
    return (
        <>
            ...
            lg:bg-white lg:border-r-[1px] lg:pb-4 lg:flex lg:flex-col justify-between dark:bg-black">
                ...
                <nav className="mt-4 flex flex-col justify-between items-center">
                    <div onClick={() => setIsOpen(true)} className="cursor-pointer hover:opacity-75 transition"> <Avatar user={currentUser} /></div>
                </nav>
            </div>
        </>
    )
